...
return {
    rosewater = rosewater, rosewaterAlpha = rosewaterAlpha,
    flamingo = flamingo, flamingoAlpha = flamingoAlpha,
    pink = pink, pinkAlpha = pinkAlpha,
    mauve = mauve, mauveAlpha = mauveAlpha,
    red = red, redAlpha = redAlpha,
    maroon = maroon, maroonAlpha = maroonAlpha,
    peach = peach, peachAlpha = peachAlpha,
    yellow = yellow, yellowAlpha = yellowAlpha,
    green = green, greenAlpha = greenAlpha,
    teal = teal, tealAlpha = tealAlpha,
    sky = sky, skyAlpha = skyAlpha,
    sapphire = sapphire, sapphireAlpha = sapphireAlpha,
    blue = blue, blueAlpha = blueAlpha,
    lavender = lavender, lavenderAlpha = lavenderAlpha,
    text = text, textAlpha = textAlpha,
    subtext1 = subtext1, subtext1Alpha = subtext1Alpha,
    subtext0 = subtext0, subtext0Alpha = subtext0Alpha,
    overlay2 = overlay2, overlay2Alpha = overlay2Alpha,
    overlay1 = overlay1, overlay1Alpha = overlay1Alpha,
    overlay0 = overlay0, overlay0Alpha = overlay0Alpha,
    surface2 = surface2, surface2Alpha = surface2Alpha,
    surface1 = surface1, surface1Alpha = surface1Alpha,
    surface0 = surface0, surface0Alpha = surface0Alpha,
    base = base, baseAlpha = baseAlpha,
    mantle = mantle, mantleAlpha = mantleAlpha,
    crust = crust, crustAlpha = crustAlpha,
}
